...
/**
 * Test cases for {@link DrehbindingHandler}.
 *
 * @author Tristan - Initial contribution
 */
public class DrehbindingOSGiTest extends JavaOSGiTest {

    private static final ThingTypeUID BRIDGE_THING_TYPE_UID = new ThingTypeUID("drehbinding", "bridge");
    ...
    @Test
    public void creationOfDrehbindingHandler() {
